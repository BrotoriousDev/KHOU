desc "Get GFS 84hr forecast data"
task "fetch_GFS" => "environment" do

require 'open-uri'
doc = Nokogiri.HTML(open('http://www.nws.noaa.gov/cgi-bin/mos/getmav.pl?sta=KHOU'))
linearray = doc.xpath('//pre').to_s.lines("\n").to_a
dt_info = linearray[1].scan(/\d+/)
# dt_info = ('monthmnumber,'daynumber','year','hour')
...
newdates = (starthour+6).step(starthour+66,3).to_a.map do |step|
  startdate + step.hours
end
  GfsTime.create(startdate:startdate,t_18:newdates[0],t_21:newdates[1],t_24:newdates[2]  \
...
,t_69:newdates[17],t_72:newdates[18],t_75:newdates[19],t_78:newdates[20] )
  ...
  GfsTemperature.create(startdate:startdate,t_18:t[0],t_21:t[1],t_24:t[2]  \
...
,t_69:t[17],t_72:t[18],t_75:t[19],t_78:t[20] )
  ...
  GfsDewpoint.create(startdate:startdate,t_18:d[0],t_21:d[1],t_24:d[2]  \
...
,t_69:d[17],t_72:d[18],t_75:d[19],t_78:d[20] )
  ...
  GfsWind.create(startdate:startdate,t_18:w[0],t_21:w[1],t_24:w[2]  \
